    ...
    <>
      <div className="p-6 max-w-2xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-3">
              {discoveredDevices.map((device) => (
                <Card
                  key={device.id}
                  className="cursor-pointer hover:bg-accent/50 transition-all duration-200 hover:shadow-md hover:scale-[1.02]"
        ...
        {step === "complete" && selectedDevice && (
          <div className="space-y-6">
            <Card className="border-green-200 bg-green-50 dark:border-green-900 dark:bg-green-950 animate-in fade-in duration-500">
              <CardContent className="p-8 text-center space-y-4">
                <div className="flex justify-center">
